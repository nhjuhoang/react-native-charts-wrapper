...
import RealTimeEnhancer from "./RealTimeEnhancer";
...
export default RealTimeEnhancer(ScrollEnhancer(HighlightEnhancer(ScaleEnhancer(MoveEnhancer(CombinedChart)))))
